...
const const char* SOURCE_FILES[] = {"Corvil-13052-1636559040000000000-1636560600000000000.pcap",
...
const const char* MYCLASS_FILES[] = { "file1", "file2", "file3", "file4" , "file5" , "file6" ,"file7" };
